pipeline {
    ...
    environment {
      ORG               = 'activiti'
      APP_NAME          = 'activiti-cloud-modeling'
    ...
    post {
        failure {
           slackSend(
             ...
             color: "danger",
             message: "activiti-cloud-modeling branch=$BRANCH_NAME is failed http://jenkins.jx.35.228.195.195.nip.io/job/Activiti/job/activiti-cloud-modeling/"
           )
        } 
        always {
            cleanWs()
